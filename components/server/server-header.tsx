        ...
        <DropdownMenuContent className="flex flex-col w-56 text-xs font-medium text-black dark:text-neutral-400 space-y-[2px]">
          ...
          {isAdmin && (
            <DropdownMenuItem
              ...
              className=" px-3 py-2 text-white text-sm cursor-pointer bg-[#0f172a] rounded-[16px] w-[100%]"
            >
              Server settings
          ...
          {isAdmin && (
            <DropdownMenuItem
              ...
              className=" text-rose-500 px-3 py-2 text-sm cursor-pointer bg-[#0f172a] rounded-[16px] w-[100%]"
            >
              Delete Server
